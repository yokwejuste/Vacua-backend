    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('id', models.CharField(default=uuid.UUID('c3f72728-9104-4cdd-89f8-b49521159237'), editable=False, max_length=50, primary_key=True, serialize=False)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('reservations', models.ManyToManyField(related_name='halls', to='classroom.reservations')),
                ('school', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='classroom.schools')),
            ],
            options={
                'verbose_name': 'Hall',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('hod', models.CharField(blank=True, max_length=100, null=True, verbose_name='Head of Department')),
                ('school', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='departments', to='classroom.schools')),
            ],
            options={
